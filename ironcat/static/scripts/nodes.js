    ...
    var GraphCreator = (function () {
        function GraphCreator(svg, nodes, edges, inputs, outputs) {
            ...
            this.dragmove = function (d) {
                ...
                if (state.pinDrag) {
                    var sourcePos = d.func ? add(d, [consts.nodeWidth / 2, (state.mouseDownPin - (d.func.outputs.length - 1) / 2) * consts.pinSpacing]) : [0, -25 * (func.inputs.length - 1) + state.mouseDownPin * 50];
